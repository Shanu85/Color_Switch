...
public class NewGame {
    ...
    public void buttonPlay(){
        String path = "C:\\Users\\shanu\\IdeaProjects\\TestingCodesAp\\Color_Switch_Test\\src\\media\\buttonClick.mp3";
    ...
    public   static void gameScreenPlay(){
        String path = "C:\\Users\\shanu\\IdeaProjects\\TestingCodesAp\\Color_Switch_Test\\src\\media\\gamePlay.mp3";
        Media media = new Media(new File(path).toURI().toString());
